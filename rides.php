    ...
    <div id="nav">
        ...
        <div id="body">            
            <div id="content">
                <div class="box">                                  
              		<?php
                	$query = "SELECT * FROM rollercoaster r INNER JOIN parks p ON p.id = r.park_id ORDER BY p.name";
  					...
  					$result = mysqli_query($db, $query)
   					...
   					while($row = mysqli_fetch_array($result)) {
						...
						$id = $row['id'];
		  				echo "<tr><td>$name</td><td ><a href = \"park.php?id=" . $id . "\">$park</a></td><td >$type</td><td >$speed mph</td><td >$height ft</td><td >$length min</td></tr>\n";
	   				 }
	   				 echo "</table>\n"; 
                ?>
